...
public class FindRightInterval {
    ...
    public static  int[] findRightInterval(int[][] intervals) {
        ...
        // create an array to do binary search
        ...
        // find the condition for intervals startj >= endi
        for (int[] interval : intervals) {

            String n = doBinarySearch(arr, interval[1]);
    ...
    //returning string because -1 can be also there in array and -1 also
    // represents not - to avoid amibguity
    static String doBinarySearch(int[] arr, int target) {
        int start = 0;
